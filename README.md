...
```bash
git clone [https://github.com/ayu853/Satellite-Imagery-Based-Property-Valuation.git](https://github.com/ayu853/Satellite-Imagery-Based-Property-Valuation.git)
